package com.anjeludo.microservicios.businesslogicapi;
...
import com.anjeludo.microservicios.businesslogicapi.exception.NonHttpCompliantException;
import com.anjeludo.microservicios.businesslogicapi.exception.NotFoundException;
import com.anjeludo.microservicios.businesslogicapi.feign.ReportsApiClient;
import com.anjeludo.microservicios.businesslogicapi.json.FizzBuzzJson;
import com.anjeludo.microservicios.businesslogicapi.json.FizzBuzzJsonRequest;
import com.anjeludo.microservicios.businesslogicapi.json.FizzReport;
...
import com.anjeludo.microservicios.businesslogicapi.repository.FizzBuzzRepository;
...
public class FizzBuzzController {
    ...
    public List<FizzBuzzJson> getAllFizzBuzzes() {
        final List<FizzBuzzJson> result = fizzBuzzRepository.findAll().stream()
                .map(entity -> new FizzBuzzJson(entity.getFizz(), entity.getBuzz(), entity.getIsFizzBuzz()))
    ...
    public FizzBuzzJson getFizzBuzz(@PathVariable Long fizzBuzzId) {
        ...
        final FizzBuzzJson json = new FizzBuzzJson(fizzBuzz.getFizz(), fizzBuzz.getBuzz(), fizzBuzz.getIsFizzBuzz());
    ...
    public void createFizzBuzz(@RequestBody FizzBuzzJsonRequest request, HttpServletResponse response) {
        final FizzBuzz entity = fizzBuzzRepository.save(new FizzBuzz(request.getFizz(), request.getBuzz(), request.getIsFizzBuzz()));
